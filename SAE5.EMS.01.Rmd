...
```{r}
# "C:/Users/33749/OneDrive/Documents/SAE5.EMS.01-Application statistique/monde.shp"
...
precipitations = openxlsx::read.xlsx("U:/Documents/S5/SAE5.EMS.01-Application statistique/haut_moy_precip.xlsx", sheet="Data", startRow=4)
...
emissions_co2 = openxlsx::read.xlsx("U:/Documents/S5/SAE5.EMS.01-Application statistique/emissions_co2.xlsx", sheet="Data", startRow=4)
...
nrow(data_t)
write.xlsx(data_t, file = "U:/Documents/S5/SAE5.EMS.01-Application statistique/data_t.xlsx", rownames=TRUE)
```
...
```{r}
monde <- st_read("U:/Documents/S5/SAE5.EMS.01-Application statistique/monde.shp") 
head(monde)
dim(monde)
```
...
dim(monde)
dim(monde_data)
# write.csv(monde_data, file = "U:/Documents/S5/SAE5.EMS.01-Application statistique/monde_data.csv", row.names = TRUE)
```
